...
/// A test context for the lending program.
///
...
impl LendingTestContext {
    ...
    /// # Returns
    ///
    /// * `Ok(LendingTestContext)` - A new test context
...
impl Default for LendingTestContext {
    fn default() -> Self {
        Self {
