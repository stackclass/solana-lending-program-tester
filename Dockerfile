...
COPY . .
RUN cargo build --release --bin solana-lending-program-tester
...
COPY --from=builder /app/target/release/solana-lending-program-tester /app/

# What the container should run when it is started
ENTRYPOINT ["/app/solana-lending-program-tester"]
